...
public class Bank {
    ...
    public void determineAccountType(String accountType){
        ...
        if(accountType.equals("saving")){
            ...
            ob1.setNoOfYears(yr);
            ob1.setBalance(bal);
            System.out.println("The Interest of "+ob1.getAccountName()+" of Account Type "+accountType+" is "+ob1.calculateInterest());
            System.exit(0);
        }
            ...
            System.out.println("The Interest for "+ob2.getAccountName()+" of Account Type "+accountType+" is "+ob2.calculateInterest());
        }
